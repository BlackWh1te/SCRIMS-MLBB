...
import com.scrimslegends.app.data.local.TeamDao
import com.scrimslegends.app.data.local.TeamEntity
    ...
    private fun mapTeamApplicationDtoToModel(dto: TeamApplicationDto): TeamApplication {
        return TeamApplication(
            ...
            status = when (dto.status) {
                "Accepted" -> com.scrimslegends.app.data.model.TeamApplicationStatus.ACCEPTED
                "Declined" -> com.scrimslegends.app.data.model.TeamApplicationStatus.DECLINED
                else -> com.scrimslegends.app.data.model.TeamApplicationStatus.PENDING
            },
            message = dto.message,
            createdAt = parseCreatedAt(dto.createdAt),
    ...
    private fun parseRealtimeRecordToTeamInvite(record: com.google.gson.JsonObject): TeamInvite {
        return TeamInvite(
            ...
            status = when (record.get("status")?.asString) {
                "Accepted" -> com.scrimslegends.app.data.model.InviteStatus.ACCEPTED
                "Declined", "Rejected" -> com.scrimslegends.app.data.model.InviteStatus.DECLINED
                else -> com.scrimslegends.app.data.model.InviteStatus.PENDING
            },
