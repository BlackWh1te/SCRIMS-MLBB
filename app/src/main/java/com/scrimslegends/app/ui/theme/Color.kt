...
val LightTextPrimary   = Color(0xFF1A1C2E)
val LightTextSecondary = Color(0xFF6B7A96)
val LightBorder        = Color(0xFFE3E8F0)
val LightBorderVariant = Color(0xFFEDF0F5)
val LightPrimary       = BluePrimary
val LightSecondary     = Color(0xFF1565C0)
val LightTertiary      = Color(0xFF5E35B1)
...
val GoldGradient = listOf(Color(0xFFFFD700), Color(0xFFFFA000))
