...
import com.scrimslegends.app.data.repository.ScrimRepository
import com.scrimslegends.app.data.repository.MatchResultRepository
...
class SecurityAuditTest {
    ...
    fun `signIn accepts any valid email format without real auth in mock`() = runBlocking {
        val repo = AuthRepository()
        val results = mutableListOf<com.scrimslegends.app.data.model.AuthResult>()
